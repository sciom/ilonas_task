...
trees.to_csv("output/trees_and_distances.csv")
...
# ctx.add_basemap(ax, crs=trees_wgs84.crs, source=ctx.providers.OpenStreetMap.Mapnik)
...
plt.savefig("output/sound_and_tree_data.png")
plt.show()
